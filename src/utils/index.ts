/*
 * @Author: hanlirong
 * @Date: 2025-02-11 15:54:57
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2025-02-11 15:55:02
 * @Description: 工具
 */
...
export function formatWordEntry(entry: {
  word: string;
  sentences: { key: number | string; value: string }[];
}): string {
  const { word, sentences } = entry;
